...
"admin"        })    }, tags={ "PHASE 1", "Subscriptions" })
    ...
    ResponseEntity<SubscriptionResponse> postSubscription(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody SubscriptionRequest body);
